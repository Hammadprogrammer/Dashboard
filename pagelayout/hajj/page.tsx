...
export default function HajjDashboardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (title.trim().length < 3) return showModal(" Title is too short.", "warning");
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto mt-8 md:mt-12">
      <h1
        ...
        id="hajj-heading"
      >
        <AcademicCapIcon className="h-8 w-8 mr-2" /> Hajj Packages Dashboard
      </h1>
      ...
      >
        ...
        {!!id && <p className="text-xs text-gray-400">Category cannot be changed when editing.</p>}
