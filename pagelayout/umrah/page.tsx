...
export default function UmrahDashboardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isNaN(priceValue) || priceValue <= 0)
      return showModal(" Enter a valid price (e.g., 999.00)", "warning");
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto mt-8 md:mt-12">
      <h1
        ...
        id="umrah-heading"
      >
        <HomeModernIcon className="h-8 w-8 mr-2" /> Umrah Packages Dashboard
      </h1>
      ...
      >
        ...
        <input
          type="text"
          name="title"
          placeholder="Package Title (e.g., 7-Day Ramadan Umrah)"
          value={title}
            ...
            >
              ...
              <div className="flex justify-between gap-2 mt-auto pt-3 border-t border-gray-700">
                ...
                <div className="flex gap-2">
                  <Link href="#umrah-heading" passHref>
                    <button
